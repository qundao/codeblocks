 ...
 *
 * $Revision: 13292 $
 * $Id: expression.cpp 13292 2023-05-30 15:50:46Z mortenmacfly $
 * $HeadURL: svn://svn.code.sf.net/p/codeblocks/code/trunk/src/plugins/contrib/clangd_client/src/codecompletion/parser/expression.cpp $
 */
